...
class ThrowerAnt(Ant):
    ...
    def nearest_bee(self, beehive):
        ...
        curr_range  = 0
        while place_check.bees == [] or curr_range < self.min_range:
            if place_check.entrance.bees is beehive.bees:
                break
            elif curr_range + 1 > self.max_range:
                break
            else:
...
class FireAnt(Ant):
    ...
    def reduce_armor(self, amount):
        ...
        for bee in bees:
            bee.reduce_armor(attack_damage) 
...
class ScubaThrower(ThrowerAnt):
    """A ThrowerAnt that is more costly and watersafe"""
    name = 'ScubaThrower'
    implemented = True
    food_cost = 6
    is_watersafe = True
...
# END Problem 13
    ...
    def __init__(self, armor=1):
        ...
        if QueenAnt.has_true_queen == False:
    ...
    def action(self, colony):
        ...
        # BEGIN Problem 13
        "*** YOUR CODE HERE ***"
        def double_damage_if_not_already(ant):
            if ant.has_doubled_damage == False:
                ant.has_doubled_damage = True
                ant.damage *= 2
        if self.is_true_queen == False:
            ...
            while place != None:
                if place.ant != None:
                    double_damage_if_not_already(place.ant)
                    if place.ant.is_container and place.ant.contained_ant != None:
                        double_damage_if_not_already(place.ant.contained_ant)
                place = place.exit
        # END Problem 13
    ...
    def reduce_armor(self, amount):
        ...
        # BEGIN Problem 13
        "*** YOUR CODE HERE ***"
        if self.is_true_queen and self.armor - amount <= 0:
            bees_win()
...
def apply_effect(effect, bee, duration):
    ...
    # BEGIN Problem EC
    "*** YOUR CODE HERE ***"
    action_saver = bee.action
    def f(colony):
        nonlocal duration
        if duration > 0:
            duration -= 1
            effect(action_saver, bee)(colony)
        else:
            action_saver(colony)
    bee.action = f
    # END Problem EC
...
class ScaryThrower(ThrowerAnt):
    ...
    def throw_at(self, target):
        # BEGIN Problem EC
        "*** YOUR CODE HERE ***"
        if target and not target.has_scare:
