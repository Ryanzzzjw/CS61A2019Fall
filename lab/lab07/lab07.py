...
def is_bst(t):
    ...
    """
    "*** YOUR CODE HERE ***"
    def bst_helper(t, bst_min, bst_max):
        if isinstance(t, Tree) == False:
            return False
        elif t.label < bst_min or t.label > bst_max:
            return False
        elif t.is_leaf():
            return True
        elif len(t.branches) == 1:
            return bst_helper(t.branches[0], bst_min, bst_max)
        elif len(t.branches) == 2:
            return bst_helper(t.branches[0], bst_min, t.label) and bst_helper(t.branches[1], t.label, bst_max)
        else:
            return False
